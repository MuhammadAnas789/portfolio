...
export default function Experience() {
  return (
    <section id="experience" className="py-24 bg-[#1e293b]/30">
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-[#f1f5f9]">Experience</h2>
        </motion.div>

        {/* Timeline */}
        <div className="relative">
          {/* Vertical line */}
          <div className="absolute left-4 top-0 bottom-0 w-0.5 bg-[#334155] hidden sm:block" />
          ...
          <div className="flex flex-col gap-12">
            {experiences.map((exp, i) => (
              ...
              >
                {/* Timeline dot */}
                <div className="hidden sm:block absolute left-[9px] top-1.5 w-3 h-3 rounded-full bg-[#2dd4bf] border-2 border-[#0f172a] shadow-[0_0_0_4px_#2dd4bf22]" />

                <div className="bg-[#1e293b] rounded-xl p-6 border border-[#334155]/50 hover:border-[#2dd4bf]/30 transition-colors">
                  <div className="flex flex-wrap items-start justify-between gap-2 mb-1">
                    <div>
                      <h3 className="text-[#f1f5f9] font-semibold text-lg">{exp.role}</h3>
